...
export function MobileMenu({ trigger }: { trigger: React.ReactNode }) {
  ...
  return (
    <div className="lg:hidden">
      ...
      {open ? (
        <div className="fixed inset-0 z-[100] bg-[#11205A]" role="dialog" aria-modal="true">
          <div className="ml-auto flex h-full w-[86%] max-w-sm flex-col border-l border-[#E5E7EB] bg-white p-6 shadow-2xl">
            ...
            <nav className="mt-8 grid gap-2 bg-white">
