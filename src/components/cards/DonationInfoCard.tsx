...
export function DonationInfoCard() {
  return (
    <article className="rounded-[2rem] border border-[#B9DBFF] bg-white p-6 shadow-xl md:p-8">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row"><CopyButton value={`${donationInfo.bank} ${donationInfo.account}`} label="후원계좌 복사" /><a href={donationInfo.phoneHref} className="btn-base btn-yellow"><Phone size={17} aria-hidden />전화문의</a></div>
